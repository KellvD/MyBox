...
class CDImageViewController: CDBaseAllViewController,
...
//        collectionView.mj_footer = mjFooter
    ...
    func batchHandleFiles(isBatch: Bool) {
        selectCount = 0
    ...
    @objc func outputBarItemClick() {
        ...
        outAlert.addAction(UIAlertAction(title: "取消".localize, style: .cancel, handler: { (_) in }))
        outAlert.addAction(UIAlertAction(title: "确定".localize, style: .default, handler: { (_) in
...
//        }))
        ...
        sheet.addAction(UIAlertAction(title: "合成GIF".localize, style: .default, handler: { (_) in
        ...
        sheet.addAction(UIAlertAction(title: "合成视频".localize, style: .default, handler: { (_) in
