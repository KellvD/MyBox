...
class CDSignalTon: NSObject, CLLocationManagerDelegate {
    ...
    */
    ...
    /**
     保存原始图片
     */
    func saveOrigialImage(obj: [String: Any?], folderId: Int) {
...
//        var photo:PHLivePhoto!
    ...
    */
    @objc func getVideoAllFrame(videoPath: String) -> [UIImage] {
        ...
        generator.generateCGImagesAsynchronously(forTimes: [NSValue(time: thumbTime)]) { (_, cgImage, _, _, _) in
    ...
    */
    ...
    /**
     移除水印
    */
    func removeWaterMarkFromWindow(window: UIWindow) {
