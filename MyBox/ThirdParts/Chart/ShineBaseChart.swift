...
public class ShineBaseChart: UIView {
    ...
    func createTextLayer(frame: CGRect,item : String,titleColor:UIColor,BgColor : UIColor) -> CATextLayer {
        ...
        let string = NSAttributedString.init(string: item, attributes:[NSAttributedString.Key.foregroundColor:titleColor,NSAttributedString.Key.font:self.font])
    ...
    func getHeight(str:String,width:CGFloat) -> CGFloat{
        ...
        let dict = [NSAttributedString.Key.foregroundColor:self.yStepColor,NSAttributedString.Key.font:self.font] as [NSAttributedString.Key : Any]
